...
### Fixed
- Broken CurseForge link in README (`shieldtax` → `shield-tax`)

### Added
- Background section in README linking Kersplode's original r/wow research and the PC Gamer article
- GitHub repository topics and homepage URL for discoverability
